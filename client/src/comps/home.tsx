...
export default function Home() {
  ...
  return (
    <div className="bg-[#0A0F1C] w-screen min-h-screen flex justify-center items-center text-[#E2E8F0] p-4">
      <div className="w-full max-w-[700px] p-8 rounded-xl bg-[#1A2238] shadow-lg space-y-6">
          ...
          <div className="space-y-2 text-left">
            ...
            <Popover open={voiceOpen} onOpenChange={setVoiceOpen}>
              <PopoverTrigger asChild>
                ...
                >
                  {voiceValue
                    ? voices.find((voice) => voice.value === voiceValue)?.label
                    : 'Select voice...'}
          ...
          <div className="space-y-2 text-left">
            ...
            <Popover open={personaOpen} onOpenChange={setPersonaOpen}>
              <PopoverTrigger asChild>
                ...
                >
                  {personaValue
                    ? personas.find((persona) => persona.value === personaValue)
                        ?.label
                    : 'Select persona...'}
                  <ChevronsUpDownIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                </Button>
                    ...
                    <CommandGroup>
                      {personas.map((persona) => (
                        <CommandItem
                          ...
                          onSelect={(currentValue) => {
                            setPersonaValue(
                              currentValue === personaValue ? '' : currentValue
                            );
          ...
          <div className="space-y-2 text-left">
            ...
            <Popover open={musicOpen} onOpenChange={setMusicOpen}>
              <PopoverTrigger asChild>
                ...
                >
                  {musicValue
                    ? musics.find((music) => music.value === musicValue)?.label
                    : 'Select music track...'}
                  <ChevronsUpDownIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                </Button>
              </PopoverTrigger>
                    ...
                    <CommandGroup>
                      {audiences.map((audience) => (
                        <CommandItem
                          ...
                          onSelect={(currentValue) => {
                            setAudienceValue(
                              currentValue === audienceValue ? '' : currentValue
                            );
